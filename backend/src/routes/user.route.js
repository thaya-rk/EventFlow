...
import { registerUser, loginUser, getUser, updateUser, deleteUser } from '../controllers/user.controllers.js';
import { validateUserRegistration, validateUserLogin } from '../middlewares/validation.middlewares.js';
...
router.get("/get-user/:user_id", authMiddleware, getUser);

// Update a user by user_id
router.put("/update-user/:user_id", authMiddleware, updateUser);

// Delete a user by user_id
router.delete("/delete-user/:user_id", authMiddleware, deleteUser);
